...
public class SegmentGenerator {
    ...
    public void buildPath(Vector2D startPoint, Vector2D controlPoint, Vector2D endPoint){
        ...
        do{
            ...
            Vector2D tangentVector = calculateFirstDerivative(startPoint, controlPoint, endPoint, t);

            Vector2D perpendicularVector = new Vector2D(tangentVector.getY(), -tangentVector.getX());

            curvaturePoints.add(perpendicularVector);
